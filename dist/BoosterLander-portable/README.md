...
---
**v0.3.0 (2026-07-24):** GM_RFLY optimizer-in-the-loop guidance (D-040 — 36/36 held-out compound
sweep, sub-meter on the drifting deck; `--rfly` CLI), photoreal renderer pass (TSL ocean/soot/deck,
real legs+bells, shadows, exposure calibration), N3 first light (live compound landings incl. the
ENGINE OUT button answered mid-flight by async replans), packaging fix (embedded UI unconditional).
