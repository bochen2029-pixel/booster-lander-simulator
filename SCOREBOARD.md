...
| **GM_RFLY BLIND + EVENT + 1/32 BUDGET — SEALED POOL 9300–9309** | **586/600 = 97.7%** | **Flown ONCE on virgin seeds (D-061).** 69 PERFECT; per seed 59/59/60/59/59/56/60/59/55/60. **16 plant rollouts per replan.** Side by side with D-055 on its own pool, never as a difference: **the same sealed rate at a quarter of the compute.** Dev pool (E6): 179/180. Band spent for this claim | **D-061** |
